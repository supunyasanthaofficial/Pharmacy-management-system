...
export default function BillingSystem() {
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="mx-auto max-w-7xl rounded-2xl bg-teal-100 p-6">
        <div className="mb-4 flex items-center justify-between">
          <h1 className="text-lg font-semibold">Billing / POS System</h1>

          <div className="flex items-center gap-4 text-sm">
            <span className="font-medium text-green-600">
              Jane Doe
              <span className="block text-xs text-gray-600">Cashier</span>
            </span>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="rounded-xl bg-white p-4 shadow">
              ...
              <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div className="w-full rounded-lg border p-4 text-sm md:w-1/2">
                  ...
                  <div className="mt-4 flex gap-3">
                    <button className="rounded-lg border px-6 py-2 ">
                      Cash
                    </button>
                    <button className="rounded-lg border px-6 py-2">
                      Card
                ...
                <button className="h-12 rounded-lg bg-teal-600 px-6 text-white flex items-center gap-2">
                  <Printer size={20} />
                  Print Bill
                </button>
              </div>
      ...
      {showReceipt && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="relative w-full max-w-5xl rounded-2xl bg-[#bfe3dc] p-8 shadow-2xl">
            <button
            ...
            <div className="mb-8 flex items-center justify-between">
              ...
              <div className="flex gap-4">
                <button className="flex items-center gap-2 rounded-xl border border-gray-300 bg-white px-6 py-3 font-medium shadow-sm">
                  <Printer size={18} />
                  Print Invoice
                </button>
      ...
      {showReturn && (
        <div className="fixed  inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-6xl rounded-4xl bg-teal-100 p-6 shadow-xl">
            <div className="mb-4 flex items-center justify-between">
            ...
            <div className="mb-4 flex flex-wrap items-center justify-between rounded-lg bg-orange-200 px-4 py-3 text-sm">
              <span>
                Return Invoice No : <b>INV.000524</b>
              </span>
              <span>🕒 December.25.2025</span>
              <span>Total : Rs. 280.00</span>
              <span>Paid : Cash</span>
            </div>
            ...
            <div className="mb-4 flex items-center gap-3">
              ...
              <button className="rounded-lg bg-gray-200 px-6 font-medium">
                Search
              </button>
            </div>
            ...
            <div className="rounded-xl bg-white p-4">
                ...
                <tbody>
                  {[1, 2, 3].map((_, i) => (
                    <tr key={i} className="border-b">
                      ...
                      <td className="py-3 font-medium">Panadol 500mg</td>
                      ...
                      <td className="text-center font-semibold">Rs. 20.00</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              ...
              <div className="mt-6 flex flex-col items-end gap-4">
                <div className="text-xl font-bold text-green-600">
                  Total Refund Amount : Rs. 700.00
                </div>

                <div className="flex gap-3">
                  <button className="rounded-lg bg-teal-700 px-6 py-2 text-white">
                    Cash
                  </button>
                  <button className="rounded-lg border px-6 py-2">Card</button>
                </div>
              </div>
            </div>

            <div className="mt-4 rounded-xl bg-white p-4">
              <h4 className="mb-2 font-medium">Refund Note</h4>
              <textarea
                rows="3"
              ...
              <div className="mt-4 text-right">
                <button className="rounded-lg bg-teal-700 px-8 py-2 text-white">
                  Complete Refund
                </button>
              </div>
            </div>
